...
func (b *ControllerSuite) TestUpdateRemoveController(c *C) {
	mngr := Manager{}
	mngr.UpdateController(&Controller{Name: "test"})
...
func (b *ControllerSuite) TestRemoveAll(c *C) {
	mngr := Manager{}
	mngr.UpdateController(&Controller{Name: "test1"})
	mngr.UpdateController(&Controller{Name: "test2"})
	mngr.UpdateController(&Controller{Name: "test3"})
	mngr.RemoveAll()
}
